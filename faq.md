...
A: Each accepted paper will be presented in a pre-recorded oral session of no more than 20 minutes.  The NeurIPS recording team, Slideslive, will contact all accepted papers via email with presentation instructions in early November. Recorded presentations for contributed talks must be uploaded no later than November 14. On the day of the workshop, we will stream pre-recorded talks and host an interactive Q&A session with all speakers. Please let us know if you have specific time constraints that will limit your ability to attend your Q/A session by December 6.  

#### Q: What will the schedule look like on Dec. 12?   
A: All live workshop events will take place on the calendar day of Dec. 12 in Vancouver, Canada to respect the original conference location. The specific timeline of our workshop has not been finalized, but we expect to have events throughout the day so that people from around the globe can attend at an agreeable time. Please let us know if you have specific constraints.   
